...
const { globalLimiter, authLimiter, assistantLimiter, connectRedisAndUpgradeStores } = require('./rateLimiter');
...
app.post('/api/assistant/chat', authenticateToken, assistantLimiter, async (req, res) => {
